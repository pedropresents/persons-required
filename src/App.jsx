          ...
          <div style={{ padding: "0 20px" }}>
            ...
            <div style={{ background: surface, borderRadius: "16px", padding: "16px", marginBottom: "14px" }}>
              ...
              <button
                ...
                style={{
                  marginTop: "10px", width: "100%", padding: "12px", borderRadius: "12px", border: "none", cursor: "pointer", fontWeight: "700", fontFamily: "'Syne',sans-serif", fontSize: "14px", transition: "all 0.15s",
